<?php
/**
 * Multi Select Dropdown Field Type Helper
 *
 ...
 */
class BBL_Field_Type_Select_Multi extends BBL_Field_Type {
	...
	public function __construct( $args = array() ) {
		...
		$args = wp_parse_args(
			...
			array(
				'type'        => 'multiselect',
				'label'       => _x( 'Multi Dropdown', 'Field type label', 'buddyblog-pro' ),
				'description' => _x( 'Multi Dropdown field.', 'Field type label', 'buddyblog-pro' ),
				'supports'    => array(
					'multiple' => true,
					'settings' => true,
				),
	...
	public function edit_field_markup( $args ) {
		...
		<select <?php echo $this->get_html_attributes( $atts ); ?> multiple>
			<?php
	...
	public function admin_field_settings_markup( $args = array() ) {
		...
		<div class="bbl-row bbl-row-cf bbl-row-cf-field-multiselect-options">
			<label class="bbl-label bbl-label-cf bbl-col-left">
				<?php _e( 'Options:', 'buddyblog-pro' ); ?>
			</label>
			<div class="bbl-col-right bbl-col-cf-field-multiselect-options">
				<input type="text" placeholder="<?php _e( 'e.g one,two,three', 'buddyblog-pro' ); ?>" name="bbl-input-cf-field-multiselect-options" />
				<?php _e( 'Comma separated list of input options', 'buddyblog-pro' ); ?>
			</div>
		</div><!-- end of row -->

		<div class="bbl-row bbl-row-cf bbl-row-cf-field-multiselect-labels">
			<label class="bbl-label bbl-label-cf bbl-col-left">
				<?php _e( 'Option Labels:', 'buddyblog-pro' ); ?>
			</label>
			<div class="bbl-col-right bbl-col-cf-field-multiselect-labels">
				<input type="text" placeholder="<?php _e( 'Labels', 'buddyblog-pro' ); ?>" name="bbl-input-cf-field-multiselect-labels"/>
