 ...
 */
class BBL_Field_Type_Text extends BBL_Field_Type {
	...
	public function __construct( $args = array() ) {
		...
		$args = wp_parse_args(
			...
			array(
				'type'        => 'text',
				'label'       => _x( 'Text', 'Field type label', 'buddyblog-pro' ),
				'description' => _x( 'Single line text field.', 'Field type label', 'buddyblog-pro' ),
