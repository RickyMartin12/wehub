...
= 6.0.6 =
* New: Added mrp_structured_data_item_type filter
* Fix: Special characters causing invalid JSON-LD markup
* New: Added mrp_filter_taxonomy_post_types filter to support other post types (only post and page post types are enabled by default)

= 6.0.5 =
* Fix: Review JSON-LD syntax error
