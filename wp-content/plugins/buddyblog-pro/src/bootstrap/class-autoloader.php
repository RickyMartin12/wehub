...
/**
 * Auto Loader for BuddyPress_User_Privacy.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the BuddyBlog_Pro\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/bp-user-privacy/src/bar/baz/class-qux.php:
 *
 *      new BuddyBlog_Pro\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/bp-user-privacy/src/bar/baz-xyz/class-qux.php
...
class Autoloader {
	...
	/**
	 * Namespace root. eg. BuddyBlog_Pro\\(escaped slashes);
	 *
	 * @var string
	 */
