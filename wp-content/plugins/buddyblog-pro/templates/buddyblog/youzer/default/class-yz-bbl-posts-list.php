<?php
/**
 * Posts lists class for Youzer compat
 *
...
/**
 * Extends Youzer's Post tab to override pagination(current page).
 * @see YZ_Posts_Tab
 */
class YZ_BBL_Posts_List {
		...
		foreach ( $blogs_ids as $b ) {
			...
			<?php if ( $posts_query->have_posts() ) : $posts_exist = true; ?>
				...
				<?php while ( $posts_query->have_posts() ) : $posts_query->the_post(); ?>
					...
					<div class="yz-tab-post bbl-yz-post ">
	 ...
	 * # Pagination.
	 */
	public function pagination( $numpages = '', $base = null ) {

		// Get current Page Number: BuddyDev mods.
		$paged = bp_action_variable( 1 );
		$paged = $paged ? $paged : 1;
		// end of BuddyDev mods.
