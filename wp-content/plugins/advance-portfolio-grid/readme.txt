=== Advance Portfolio Grid and Slider ===
Contributors: wpbean
Tags: advance portfolio, portfolio grid, portfolio slider, post grid, free portfolio, WordPress portfolio, portfolio gallery, filterable gallery, elementor, elementor portfolio, elementor portfolio, WooCommerce
...
* Fully Translation ready, WPML and Loco translate plugin supported.
* Work with any theme.
...
* **orderby**: Portfolio items order by. Default: date. Please visit this [link](https://developer.wordpress.org/reference/classes/wp_query/#order-orderby-parameters "Order & Orderby Parameters") for more details.
...
1. Portfolio Grid
2. Portfolio Slider
3. Portfolio Quick View Popup
4. Elementor widget for the Portfolio
5. Portfolio Generel Settings.
6. Portfolio Advanced Settings.
7. Portfolio Style Settings.
8. Portfolio Slider Settings.
